...
# Essa parte é do tupo de sorvete
if tipo_sorvete == "casquinha":
    ...
    print("Somente deverá escolher o tipo [casquinha, cascão, cestinha]")
...
if cobertura in coberturas:
    ...
    print("Somente temos as opções de cobertura [caramelo, morango, chocolate, ]")
